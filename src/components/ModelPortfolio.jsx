    ...
    return (
        <div className='text-center px-5 lg:px-28'>
            ...
            {/* <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-7  gap-20 items-center  px-16'>
               ...
               <div className='flex'> {icons.map((icon)=>(<div>{icon.icon}</div>))}</div>
                ...
                {portfolio.map((item, index) => (
                    <div key={index} className='flex flex-col lg:flex-row items-center'
                     onClick={() => {
                        ...
                        <div className={`m-auto  cursor-pointer ${activeIndex === index ? 'fill-black' : 'fill-slate-500'}`}>
                            <div className={`${activeIndex === index ? 'fill-black' : 'fill-slate-500'}`}>{icons[index] && icons[index].icon}</div>
                            <p className={`${activeIndex === index ? 'text-black' : 'text-slate-500'}`}>{item.name}</p>
                        </div>
                    </div>
                ))}
            </div>
                    ...
                    portfolio.map((item, index) => (
                        <div key={index}>
                            ...
                            <div onClick={() => {
                                handleCatagory(index)
                                setActive(!false)
                            }} key={index} className={`text-center cursor-pointer ${activeIndex === index ? 'text-black' : 'text-gray-600'}`}>

                                <p className={` text-sm font-semibold ${activeCatgory === true && index === activeIndex ? 'text-black font-semibold text-lg' : 'text-gray-600'}`}>{item.name}</p>
